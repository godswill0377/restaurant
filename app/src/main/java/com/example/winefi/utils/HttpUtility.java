...
//        httpConn.addRequestProperty("cb-tz", "+0530");
//        httpConn.addRequestProperty("cb-appver", "4.3.011");
//        httpConn.addRequestProperty("application", "application/x-protobuf");
//        httpConn.addRequestProperty("cb-loc", "IN");
////        httpConn.addRequestProperty("accept-encoding", "gzip");
//        httpConn.addRequestProperty("cb-loc", "IN");
//        httpConn.addRequestProperty("if-modified-since", "Tue, 06 Feb 2018 11:54:45 GMT");
//        httpConn.addRequestProperty("cookie", "__cfduid=d9b5ab71e02bea69f0556c7c56ce6d5851517915141");
//        httpConn.addRequestProperty("User-Agent", "okhttp/3.8.0");
//        httpConn.addRequestProperty("authentication", "1517917623-pVWclgaiutFezTepqleI1TbkbVxlkSGMmJLMB2DC4xM=");
